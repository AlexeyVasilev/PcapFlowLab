...
- IP-in-IP, AH, L2TP, NAT-T ESP over UDP/4500, GRE shapes outside the documented GRE v0 direct-inner-IP subset, or GTP-U shapes outside the documented GTPv1-U T-PDU subset;
