...
- GTP-U fixture generator, strict inner flow-tuple extraction, deterministic fixtures, flow fixture tests, and selected-packet Summary / Protocol details are implemented.
