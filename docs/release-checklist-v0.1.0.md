...
- useful TCP, TLS, HTTP, and narrow QUIC stream inspection
...
- [ ] Stream view is useful on supported TCP/TLS/HTTP cases.
- [ ] Narrow QUIC inspection is usable on known supported cases and falls back conservatively otherwise.
...
- [ ] Core public docs exist and are minimally coherent: README, build/run instructions, current state, roadmap, and this release checklist.
...
- QUIC handling remains narrow, bounded, and mostly presentation-oriented rather than session-complete.
...
- [ ] Current-state and roadmap docs make the project's maturity and direction obvious.
...
- [ ] QUIC support is honest about being narrow and conservative.
