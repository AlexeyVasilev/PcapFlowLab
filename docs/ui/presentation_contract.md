...
- Linux cooked SLL v1 packet-byte units now use authoritative cooked-header whole-unit and payload ranges for selected-packet byte materialization; Linux cooked SLL2 packet-byte units remain deferred;
