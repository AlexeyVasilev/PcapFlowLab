...
char* pfl_frontend_session_adapter_apply_advanced_flow_filter_structured_document_json(
    ...
    std::size_t packet_distribution_include_id_count,
    const char* const* packet_distribution_exclude_ids_utf8,
    std::size_t packet_distribution_exclude_id_count,
    const char* const* data_distribution_include_ids_utf8,
    std::size_t data_distribution_include_id_count,
    const char* const* data_distribution_exclude_ids_utf8,
    std::size_t data_distribution_exclude_id_count,
    ...
    std::size_t traffic_directional_packets_count,
    ...
    std::size_t traffic_directional_original_bytes_count,
