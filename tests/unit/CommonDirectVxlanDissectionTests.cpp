...
void expect_vxlan_fixture_packet_parity() {
    ...
    const std::array expectations {
        ...
        FixturePacketExpectation {"parsing/vxlan/05_vxlan_truncated_header.pcap", 0U, "EthernetII -> IPv4 -> UDP"},
        FixturePacketExpectation {"parsing/vxlan/06_vxlan_invalid_flags_or_reserved_bits.pcap", 0U, "EthernetII -> IPv4 -> UDP"},
        FixturePacketExpectation {"parsing/vxlan/07_vxlan_truncated_inner_ethernet.pcap", 0U, "EthernetII -> IPv4 -> UDP"},
        FixturePacketExpectation {"parsing/vxlan/08_vxlan_truncated_inner_ipv4.pcap", 0U, "EthernetII -> IPv4 -> UDP"},
        FixturePacketExpectation {"parsing/vxlan/09_vxlan_unsupported_inner_ethertype.pcap", 0U, "EthernetII -> IPv4 -> UDP"},
...
void expect_vxlan_identity_behavior() {
    ...
    expect_identity_cardinality("parsing/vxlan/10_vxlan_same_inner_tuple_different_vni.pcap", 2U);
    expect_identity_cardinality("parsing/vxlan/11_vxlan_inner_ipv4_tcp_bidirectional.pcap", 1U);
    expect_identity_cardinality("parsing/vxlan/12_vxlan_same_outer_tuple_different_inner_flows.pcap", 2U);
    expect_identity_cardinality("parsing/vxlan/16_vxlan_vni_boundary_values.pcap", 2U);
    expect_identity_cardinality("parsing/vxlan/22_vxlan_identity_outer_carrier_variation_same_flow.pcap", 1U);
    expect_identity_cardinality("parsing/vxlan/23_vxlan_identity_outer_and_inner_vlan_splits.pcap", 4U);
    expect_identity_cardinality("parsing/vxlan/30_vxlan_vni_byte_order_distinct_values.pcap", 2U);
