...
void run_malformed_packet_handling_tests() {
...

    {
        ...
        expect_safe_failure(details_service, payload_service, short_ethernet);
    }

    {
        ...
        expect_safe_failure(details_service, payload_service, short_vlan);
    }
...

    {
        ...
        invalid_ihl[14] = 0x44;
        expect_safe_failure(details_service, payload_service, invalid_ihl);
    }

    {
        auto short_tcp_header = make_ethernet_ipv4_tcp_packet(ipv4(10, 2, 0, 1), ipv4(10, 2, 0, 2), 2345, 443);
        short_tcp_header.resize(44);
        expect_safe_failure(details_service, payload_service, short_tcp_header);
    }

    {
        ...
        expect_safe_failure(details_service, payload_service, invalid_tcp_header_length);
    }

    {
        auto short_udp_header = make_ethernet_ipv4_udp_packet(ipv4(10, 4, 0, 1), ipv4(10, 4, 0, 2), 5353, 53);
        short_udp_header.resize(40);
        expect_safe_failure(details_service, payload_service, short_udp_header);
    }

    {
        ...
        expect_safe_failure(details_service, payload_service, malformed_ipv6_extensions);
    }
