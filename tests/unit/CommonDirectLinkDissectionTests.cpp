...
void expect_llc_snap_shadow_parsers_bounds_and_fixture_parity() {
    ...
    const std::vector<UnsupportedFixtureExpectation> unsupported_expectations {
        ...
        {"parsing/llc_snap/13_llc_snap_truncated_inner_ipv4.pcap", "", StopReason::malformed},
...
void expect_pppoe_ppp_shadow_parsers_bounds_and_fixture_parity() {
    ...
    const std::vector<UnsupportedExpectation> unsupported_expectations {
        ...
        {"parsing/pppoe/18_pppoe_truncated_inner_ipv4.pcap", "EthernetII", StopReason::malformed, {DissectionLayerKind::ethernet_ii, DissectionLayerKind::pppoe, DissectionLayerKind::ppp, DissectionLayerKind::ipv4}},
...
void expect_pbb_shadow_parsers_bounds_and_fixture_parity() {
    ...
    const std::vector<UnsupportedExpectation> unsupported_expectations {
        ...
        {"parsing/pbb/14_pbb_truncated_inner_ipv4.pcap", StopReason::malformed, {DissectionLayerKind::ethernet_ii, DissectionLayerKind::pbb, DissectionLayerKind::ethernet_ii, DissectionLayerKind::ipv4}},
