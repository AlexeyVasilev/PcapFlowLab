...
Deep mode already exists as a separate import path, but Fast mode remains optimized for quick browsing. The first Deep-only analyzer now populates TLS packet-level details in the Protocol tab when they are available from a single packet.
