...
Qt and Tauri provide `Statistics -> Export Statistics as HTML...` and
`Statistics -> Export Statistics as Markdown...` from the main menu. These
actions write a whole-session Statistics report using the same shared
Statistics report data as the CLI HTML/Markdown exports. The exported report is
